...
#~--- Diretorios:
DIR_ARQUIVO="/home/jardson/temporario"
DIR_IPV4="/home/jardson/temporario/getipv4"
DIR_NULL="/etc/null"
...
echo "$HOST" >> "$DIR_ARQUIVO"/lamp*
echo "$MYSQL_USER" >> "$DIR_ARQUIVO"/lamp*
echo "$MYSQL_NEW_PW" >> "$DIR_ARQUIVO"/lamp*
echo "$GETIP4" >> "$DIR_ARQUIVO"/lamp*
sleep 3
